...
import {
  ...
  selectServiceToFinish,
  updateServiceAsync,
} from '../../../redux/features/servicesSlice';

const ServiceFinish = ({ fullScreen, open, handleClose }) => {
  const { _id, serviceType } = useSelector(selectServiceToFinish) || {};
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          {`¿Esta seguro que el servicio de ${serviceType} a sido realizado?`}
        </DialogContentText>
      </DialogContent>
      <DialogActions>
        <Button
